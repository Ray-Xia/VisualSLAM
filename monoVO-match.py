...
class VisualOdometry():
    ...
    def get_pose(self, q1, q2):
        ...
        Essential, mask = cv2.findEssentialMat(q1, q2, self.K, method=cv2.RANSAC) # method有RANSAC，LMEDS，默认RANSAC
        # print ("\nEssential matrix:\n" + str(Essential))
...
def main():
    ...
    plotting.visualize_paths(gt_path, estimated_path, "Visual Odometry", file_out=os.path.basename(data_dir) + "-knnMmatch"+ ".html")
